...
.seller-menu{max-width:1280px;margin:0 auto;padding:22px 28px 0}.seller-menu-inner{border:1px solid #35333a;background:linear-gradient(145deg,#15161a,#0d0e11);padding:12px 14px;display:flex;align-items:center;justify-content:center;gap:8px;flex-wrap:nowrap;overflow-x:auto}.seller-menu-label{color:#77736e;font-size:9px;letter-spacing:.16em;font-weight:800;margin:0 8px 0 2px;white-space:nowrap;flex:0 0 auto}.seller-menu-link{position:relative;display:inline-flex;align-items:center;gap:5px;padding:10px 10px;border:1px solid transparent;color:#cfc9bf;font-size:10px;text-decoration:none;white-space:nowrap;flex:0 0 auto}.seller-menu-link:hover{border-color:#4a463d;background:#12110e;color:#d9b45f}.seller-menu-link strong{font-weight:600}.seller-menu-badge{display:inline-flex;align-items:center;padding:3px 5px;border:1px solid #5b4b2d;color:#d9b45f;font-size:8px;line-height:1}.seller-menu-link.active{border-color:#5b4b2d;color:#d9b45f;background:#15130f}@media(max-width:760px){.seller-menu{padding:18px 18px 0}.seller-menu-inner{justify-content:flex-start}.seller-menu-label{position:sticky;left:0;background:#15161a;padding-right:7px}}
</style>`;
