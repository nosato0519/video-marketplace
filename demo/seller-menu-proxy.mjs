...
.seller-menu{max-width:1080px;margin:0 auto;padding:14px 24px 0}.seller-menu-inner{border:1px solid #35333a;background:linear-gradient(145deg,#15161a,#0d0e11);padding:10px 12px;display:flex;align-items:center;gap:8px;flex-wrap:wrap}.seller-menu-label{color:#77736e;font-size:8px;letter-spacing:.16em;font-weight:800;margin:0 7px 0 3px;white-space:nowrap}.seller-menu-link{position:relative;display:inline-flex;align-items:center;gap:5px;padding:8px 9px;border:1px solid transparent;color:#cfc9bf;font-size:9px;text-decoration:none;white-space:nowrap}.seller-menu-link:hover{border-color:#4a463d;background:#12110e;color:#d9b45f}.seller-menu-link strong{font-weight:600}.seller-menu-badge{display:inline-flex;align-items:center;padding:3px 5px;border:1px solid #5b4b2d;color:#d9b45f;font-size:7px;line-height:1}.seller-menu-link.active{border-color:#5b4b2d;color:#d9b45f;background:#15130f}@media(max-width:760px){.seller-menu{padding:10px 18px 0}.seller-menu-inner{overflow-x:auto;flex-wrap:nowrap;justify-content:flex-start}.seller-menu-label{position:sticky;left:0;background:#15161a;padding-right:6px}.seller-menu-link{flex:0 0 auto}}
</style>`;
