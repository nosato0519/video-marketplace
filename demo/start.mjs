...
const featureShowcase = `<section class="system-showcase" id="system-features"><style>.system-showcase{padding:88px 6vw;border-top:1px solid #29282a;border-bottom:1px solid #29282a;background:linear-gradient(180deg,#0b0c10,#101114)}.system-showcase .ss-inner{max-width:1280px;margin:auto}.system-showcase .ss-kicker{font-size:10px;letter-spacing:.28em;color:#c6a864;font-weight:800}.system-showcase h2{font-size:clamp(34px,4.2vw,58px);line-height:1.12;letter-spacing:-.035em;margin:14px 0}.system-showcase .ss-lead{max-width:850px;color:#aaa6a0;font-size:15px;line-height:1.9}.ss-promise{display:grid;grid-template-columns:repeat(3,1fr);gap:14px;margin:34px 0 54px}.ss-promise article,.ss-feature,.ss-genre{border:1px solid #302e2d;background:linear-gradient(145deg,#141519,#0d0e11);padding:25px}.ss-promise b{display:block;font-size:20px;margin-bottom:8px}.ss-promise span,.ss-feature p,.ss-genre span{color:#99958f;font-size:12px;line-height:1.8}.ss-title{font-size:28px;margin:0 0 22px}.ss-role{margin-top:46px}.ss-role-head{display:flex;align-items:end;justify-content:space-between;gap:20px;margin-bottom:18px}.ss-role-head small{color:#b79b5b;letter-spacing:.16em}.ss-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:12px}.ss-feature b{display:block;font-size:15px;margin-bottom:7px}.ss-genre-grid{display:grid;grid-template-columns:repeat(6,1fr);gap:10px}.ss-genre strong{display:block;font-size:13px;margin-bottom:3px}.ss-flow{display:grid;grid-template-columns:repeat(5,1fr);gap:1px;background:#302e2d;margin-top:22px}.ss-step{background:#111216;padding:22px;min-height:135px}.ss-step em{font-style:normal;color:#b79b5b;font-size:10px;letter-spacing:.15em}.ss-step b{display:block;font-size:16px;margin:10px 0 5px}.ss-step span{color:#99958f;font-size:11px}.ss-custom{margin-top:48px;padding:30px;border:1px solid rgba(183,155,91,.35);background:linear-gradient(120deg,#15130f,#101114)}.ss-custom strong{font-size:21px}.ss-custom p{color:#aaa6a0;font-size:12px;margin:8px 0 0}@media(max-width:900px){.ss-promise,.ss-grid,.ss-genre-grid,.ss-flow{grid-template-columns:1fr 1fr}.ss-role-head{display:block}}@media(max-width:600px){.system-showcase{padding:65px 20px}.ss-promise,.ss-grid,.ss-genre-grid,.ss-flow{grid-template-columns:1fr}}</style><div class="ss-inner"><span class="ss-kicker">COMPLETE VIDEO MARKETPLACE SYSTEM</span><h2>動画を販売するために必要な機能を、<br><em>すべてひとつに。</em></h2><p class="ss-lead">購入者・販売者・運営者。それぞれに必要な機能をひとつの動画販売システムにまとめ、さらにロゴ・デザイン・カテゴリー・コンテンツまで自由にカスタマイズ。教育、エンタメ、クリエイター、フィットネス、音楽、ビジネスなど、どんな種類の動画販売サイトにも展開できます。</p><div class="ss-promise"><article><b>そのまま使える</b><span>完成された動画販売システムとして、必要な販売・購入・決済・視聴・管理の流れをそのまま活用できます。</span></article><article><b>自由にカスタマイズ</b><span>ロゴ、サイト名、カラー、画像、カテゴリー、商品、メニュー、トップページ、コンテンツ、世界観・デザインまでブランドに合わせて変更。</span></article><article><b>ジャンルを限定しない</b><span>販売する動画のジャンルに合わせてサイトの見せ方やカテゴリーを組み替えられます。</span></article></div><div class="ss-role"><div class="ss-role-head"><div><small>01 / BUYER</small><h3 class="ss-title">購入者の機能</h3></div></div><div class="ss-grid"><div class="ss-feature"><b>会員登録・ログイン</b><p>アカウントを作成して購入情報を管理。</p></div><div class="ss-feature"><b>動画検索・カテゴリー</b><p>キーワードやカテゴリーから作品を検索。</p></div><div class="ss-feature"><b>商品詳細・サンプル</b><p>作品情報、価格、販売者情報を確認。</p></div><div class="ss-feature"><b>カート・購入</b><p>作品をカートに入れて購入フローへ。</p></div><div class="ss-feature"><b>決済</b><p>実運営では利用する決済サービスと連携可能な構成。</p></div><div class="ss-feature"><b>マイライブラリ</b><p>購入済み作品をまとめて管理。</p></div><div class="ss-feature"><b>購入履歴</b><p>過去の注文・購入作品を確認。</p></div><div class="ss-feature"><b>保護されたコンテンツアクセス</b><p>購入権限を前提に視聴・配信する設計。</p></div><div class="ss-feature"><b>購入済み動画の視聴・ダウンロード</b><p>購入後の作品をライブラリから視聴・利用。</p></div><div class="ss-feature"><b>アカウント管理</b><p>プロフィールや購入者アカウントを管理。</p></div></div></div><div class="ss-role"><div class="ss-role-head"><div><small>02 / SELLER / CREATOR</small><h3 class="ss-title">販売者・クリエイターの機能</h3></div></div><div class="ss-grid"><div class="ss-feature"><b>販売者アカウント</b><p>販売者として作品を管理。</p></div><div class="ss-feature"><b>商品登録・編集</b><p>タイトル、説明、価格、カテゴリー等を設定。</p></div><div class="ss-feature"><b>動画アップロード</b><p>販売動画を商品と紐付けて登録。</p></div><div class="ss-feature"><b>商品画像・説明設定</b><p>サムネイルや商品説明を設定。</p></div><div class="ss-feature"><b>価格設定</b><p>作品ごとの販売価格を設定。</p></div><div class="ss-feature"><b>販売状態管理</b><p>公開・非公開・審査などを管理。</p></div><div class="ss-feature"><b>売上確認</b><p>販売数や売上を確認。</p></div><div class="ss-feature"><b>売上管理</b><p>販売実績や売上情報を管理。</p></div><div class="ss-feature"><b>出金管理</b><p>売上から出金フローへつなげる管理領域。</p></div></div></div><div class="ss-role"><div class="ss-role-head"><div><small>03 / ADMIN</small><h3 class="ss-title">運営者・管理者の機能</h3></div></div><div class="ss-grid"><div class="ss-feature"><b>ユーザー管理</b><p>購入者・販売者のアカウントや権限を管理。</p></div><div class="ss-feature"><b>販売者管理</b><p>販売者の登録状況や作品を管理。</p></div><div class="ss-feature"><b>商品・動画管理</b><p>作品の公開・非公開などを管理。</p></div><div class="ss-feature"><b>カテゴリー管理</b><p>サイト内の販売カテゴリーを管理。</p></div><div class="ss-feature"><b>注文・購入管理</b><p>注文や購入情報を確認。</p></div><div class="ss-feature"><b>決済管理</b><p>決済サービスに合わせて運営側を管理。</p></div><div class="ss-feature"><b>売上・出金管理</b><p>サイト全体の売上や出金を管理。</p></div><div class="ss-feature"><b>メディア管理</b><p>動画・サムネイル等のメディアを整理。</p></div><div class="ss-feature"><b>サイト管理</b><p>サイト全体の設定や運営内容を管理。</p></div><div class="ss-feature"><b>セキュリティ管理</b><p>認証・権限・購入者アクセスを考慮。</p></div></div></div><div class="ss-role"><div class="ss-role-head"><div><small>04 / CUSTOMIZE</small><h3 class="ss-title">カスタマイズできるもの</h3></div></div><div class="ss-grid"><div class="ss-feature"><b>ロゴ</b><p>オリジナルロゴへ変更。</p></div><div class="ss-feature"><b>サイト名</b><p>ブランド名・サービス名へ変更。</p></div><div class="ss-feature"><b>カラー</b><p>ブランドカラーに合わせて変更。</p></div><div class="ss-feature"><b>画像</b><p>メイン画像・商品画像を変更。</p></div><div class="ss-feature"><b>カテゴリー</b><p>販売ジャンルに合わせて変更。</p></div><div class="ss-feature"><b>商品情報</b><p>商品名・説明・価格等を変更。</p></div><div class="ss-feature"><b>メニュー</b><p>必要な導線に合わせて変更。</p></div><div class="ss-feature"><b>トップページ</b><p>サイトの世界観に合わせて構成。</p></div><div class="ss-feature"><b>コンテンツ</b><p>文章・紹介文・各種コンテンツを変更。</p></div><div class="ss-feature"><b>世界観・デザイン</b><p>ブランドの雰囲気に合わせてサイト全体を調整。</p></div></div></div><div class="ss-role"><div class="ss-role-head"><div><small>05 / USE CASES</small><h3 class="ss-title">どんな動画販売サイトにも</h3></div></div><div class="ss-genre-grid"><div class="ss-genre"><strong>EDUCATION</strong><span>教育・学習</span></div><div class="ss-genre"><strong>ENTERTAINMENT</strong><span>エンタメ</span></div><div class="ss-genre"><strong>CREATOR</strong><span>クリエイター作品</span></div><div class="ss-genre"><strong>FITNESS</strong><span>フィットネス</span></div><div class="ss-genre"><strong>MUSIC</strong><span>音楽・ライブ</span></div><div class="ss-genre"><strong>BUSINESS</strong><span>ビジネス</span></div><div class="ss-genre"><strong>TRAVEL</strong><span>旅行・文化</span></div><div class="ss-genre"><strong>COOKING</strong><span>料理・レシピ</span></div><div class="ss-genre"><strong>ART / DESIGN</strong><span>アート・デザイン</span></div><div class="ss-genre"><strong>SPORTS</strong><span>スポーツ</span></div><div class="ss-genre"><strong>HOW-TO</strong><span>ハウツー</span></div><div class="ss-genre"><strong>YOUR IDEA</strong><span>あなたのアイデア</span></div></div></div><div class="ss-role"><div class="ss-role-head"><div><small>06 / END-TO-END FLOW</small><h3 class="ss-title">サイト運営の流れ</h3></div></div><div class="ss-flow"><div class="ss-step"><em>01</em><b>販売者登録</b><span>販売者が参加</span></div><div class="ss-step"><em>02</em><b>作品登録</b><span>商品・動画を登録</span></div><div class="ss-step"><em>03</em><b>販売</b><span>購入者へ提供</span></div><div class="ss-step"><em>04</em><b>購入・決済</b><span>購入後ライブラリへ</span></div><div class="ss-step"><em>05</em><b>視聴・管理</b><span>購入者と運営者が管理</span></div></div></div><div class="ss-custom"><strong>動画販売ビジネスを、あなたのブランドへ。</strong><p>そのまま使える完成システムをベースに、ロゴ・サイト名・カラー・画像・カテゴリー・商品情報・メニュー・トップページ・コンテンツ・世界観・デザインまで自由にカスタマイズできます。</p></div></div></section>`;
