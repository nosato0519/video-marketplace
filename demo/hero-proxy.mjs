...
const HERO_STYLE = `<style id="hero-size-final">.hero{min-height:680px!important;height:680px!important}.hero-copy{padding-top:108px!important;padding-left:8.75vw!important;max-width:900px!important;transform:scale(1.25)!important;transform-origin:left top!important}.hero-mosaic{top:96px!important;right:3.5vw!important;width:650px!important;height:506px!important;transform:scale(1.25)!important;transform-origin:top right!important}.system-showcase{display:block!important;visibility:visible!important;opacity:1!important;position:relative!important;z-index:2!important;margin:0!important}.system-guide-teaser{display:block!important;visibility:visible!important;opacity:1!important}@media(max-width:900px){.hero{min-height:720px!important;height:720px!important}.hero-copy{padding-top:100px!important;padding-left:7vw!important;max-width:82vw!important;transform:scale(1.15)!important}.hero-mosaic{top:315px!important;right:-20px!important;width:430px!important;height:335px!important;transform:scale(1.05)!important}}@media(max-width:650px){.hero{min-height:680px!important;height:680px!important}.hero-copy{padding-top:78px!important;padding-left:6vw!important;max-width:88vw!important;transform:scale(1)!important}.hero-mosaic{top:350px!important;right:-65px!important;width:390px!important;height:304px!important;transform:scale(.9)!important;opacity:.9}}</style>`;
...
function finalize(html) {
  ...
  let guide = html.match(/<section\b[^>]*class=["'][^"']*\bsystem-guide-teaser\b[^"']*["'][^>]*>[\s\S]*?<\/section>/i);
  if (guide) {
    guide = guide[0];
    html = html.replace(guide, '');
  } else {
    guide = GUIDE_TEASER;
  }
  ...
  if (featureAgain && featureAgain.index != null) {
    ...
    html = html.slice(0, at) + guide + html.slice(at);
  } else {
    html = insertAfterHero(html, guide);
  }
