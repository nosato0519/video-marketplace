...
const injected = `${marker}
  ...
  if (req.method === 'GET' && (url.pathname === '/' || url.pathname === '/index.html')) {
    ...
    html = html.replace('/ott-home-v3.css?v=20260905-v3', '/ott-home-v12.css?v=20260905-v12');
