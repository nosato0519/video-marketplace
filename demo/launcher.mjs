...
const injected = `${marker}
  ...
  if (req.method === 'GET' && (url.pathname === '/' || url.pathname === '/index.html')) {
    ...
    const categoryNeedle = '<a class="cat c5"><b>LIFESTYLE</b><span>ライフスタイル</span><i>→</i></a>';
    const adultCard = '<a class="cat c6"><b>18+ / ADULT</b><span>アダルト・成人向け</span><i>→</i></a>';
    html = html.replace(categoryNeedle, categoryNeedle + adultCard);
