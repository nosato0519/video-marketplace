...
try {
  ...
  const secondApplication = await request(baseUrl, '/api/seller/application', { method: 'POST', headers: { cookie: secondLogin.cookie, 'content-type': 'application/json' }, body: JSON.stringify({ displayName: 'Reject Creator', legalName: 'Reject Creator Legal', countryCode: 'JP' }) });
